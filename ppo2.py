...
for i in range(num_eval):
    ...
    prediction1 = output[relevant_index].argmax().item()
    correct = prediction1 == target[relevant_index].item()
    prediction2 = output[relevant_index + 1].argmax().item()
    correct += prediction2 == target[relevant_index + 1].item()
    prediction3 = output[relevant_index + 2].argmax().item()
    correct += prediction3 == target[relevant_index + 2].item()
